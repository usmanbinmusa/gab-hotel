                    ...
                    <div className="col-12">
                        <div className="row gy-4">
                            <div className="col-md-4">
                                ...
                                <p><i className="fa fa-phone-alt text-primary me-2"></i>+2349075467138 </p>
                            </div>
                            <div className="col-md-4">
                                <h6 className="section-title text-start text-primary text-uppercase">General</h6>
                                <p><i className="fa fa-phone-alt text-primary me-2"></i>+2349012968899</p>
                            </div>
                            <div className="col-md-4">
                                <h6 className="section-title text-start text-primary text-uppercase">Enquiries</h6>
                                <p><i className="fa fa-phone-alt text-primary me-2"></i>+2348166778970</p>
                            </div>
                        </div>
                    </div>
