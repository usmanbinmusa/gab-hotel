  ...
  return (
       <>
        ...
        <div className="text-center wow fadeInUp" data-wow-delay="0.1s">
             <h6 className="section-title text-center text-primary text-uppercase">Testimonials</h6>
             <h1 className="mb-5">Explore <span className="text-primary ">Reviews</span> from our Customers</h1>
        </div>
